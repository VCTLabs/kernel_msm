...
static struct clk_lookup msm_camera_clocks_8974pro_only[] = {
	...
	CLK_LOOKUP_OF("cam_src_clk", mclk2_clk_src.c, "20.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src.c, "20.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk2_clk.c, "20.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk.c, "20.qcom,eeprom"),
